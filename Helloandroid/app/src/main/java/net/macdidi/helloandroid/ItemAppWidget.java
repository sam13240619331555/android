...
public class ItemAppWidget extends AppWidgetProvider {
    ...
    public void onDeleted(Context context, int[] appWidgetIds) {
        ...
        final int N = appWidgetIds.length;
        for (int i = 0; i < N; i++) {
            ItemAppWidgetConfigureActivity.deleteTitlePref(context, appWidgetIds[i]);
        }
    }
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
       ...
       String widgetText = ItemAppWidgetConfigureActivity.loadTitlePref(context, appWidgetId);
