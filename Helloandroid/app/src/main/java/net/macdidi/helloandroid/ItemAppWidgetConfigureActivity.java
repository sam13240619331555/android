...
public class ItemAppWidgetConfigureActivity extends Activity {
    ...
    private static final String PREFS_NAME = "net.macdidi.helloandroid.ItemAppWidget";
    ...
    public void onCreate(Bundle icicle) {
        ...
        mAppWidgetText.setText(loadTitlePref(ItemAppWidgetConfigureActivity.this, mAppWidgetId));
    }
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            ItemAppWidget.updateAppWidget(context, appWidgetManager, mAppWidgetId,widgetText);
    ...
    AdapterView.OnItemClickListener itemListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view,
            ...
            Toast.makeText(ItemAppWidgetConfigureActivity.this,
                    data[position], Toast.LENGTH_LONG).show();
            final Context context = ItemAppWidgetConfigureActivity.this;
            AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(context);
            ItemAppWidget.updateAppWidget(context, appWidgetManager, mAppWidgetId,data[position]);
            Intent resultValue = new Intent();
            resultValue.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, mAppWidgetId);
            setResult(RESULT_OK, resultValue);
            finish();
